#!/usr/bin/env python3
"""Create a Git branch from origin/master using a Jira URL and summary."""
...
def create_branch(jira_url: str, summary: str, dry_run: bool) -> str:
    ...
    run_git(["switch", "-c", branch, "origin/master"])
    return branch
...
def main() -> int:
    ...
    try:
        branch = create_branch(args.jira_url, args.summary, args.dry_run)
